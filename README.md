...
3. **`netzer-cli`**: Handles the command-line interface, argument parsing, terminal formatting, file export functionalities, and the embedded Web dashboard server.
